...
import { BlockchainInfo, BlockList, DsBlockObj, PendingTxnResult, TransactionStatusObj, PendingTxns, Provider, RPCResponse, ShardingStructure, TransactionObj, MinerInfo, TxBlockObj, TxList, ZilliqaModule } from '@zilliqa-js/core';
export declare class Blockchain implements ZilliqaModule {
     ...
     * @param txId
     */
    getPendingTxn(txId: string): Promise<PendingTxnResult>;
    /**
     * getPendingTxns
     *
