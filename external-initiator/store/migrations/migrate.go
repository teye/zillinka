...
import (
	...
	"github.com/smartcontractkit/external-initiator/store/migrations/migration1614458183"
...
func Migrate(db *gorm.DB) error {
	...
	migrations := []*gormigrate.Migration{
		...
		{
			ID:       "1614458183",
			Migrate:  migration1614458183.Migrate,
			Rollback: migration1614458183.Rollback,
		},
	}
