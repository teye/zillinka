...
func Migrate(tx *gorm.DB) error {
	...
	err = tx.AutoMigrate(&ZilSubscription{}).AddForeignKey("subscription_id", "subscriptions(id)", "CASCADE", "CASCADE").Error
	if err != nil {
...
func Rollback(tx *gorm.DB) error {
	return tx.DropTable("zilliqa_subscriptions").Error
}
